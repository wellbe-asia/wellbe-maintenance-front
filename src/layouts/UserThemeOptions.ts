...
const UserThemeOptions = (): ThemeOptions => {
  ...
  return {
    ...
    typography: {
      fontFamily:
        '"-apple-system","BlinkMacSystemFont","游ゴシック","YuGothic","ヒラギノ角ゴ Pro W3","Hiragino Kaku Gothic Pro","メイリオ","Century Gothic","Helvetica","Arial","Droid Sans","Sans-Serif"'
    },
    shadows:
      mode === 'light'
        ? [
